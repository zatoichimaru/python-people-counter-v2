...
print("Red line y:",int(line_down))
print("Blue line y:", int(line_up))
...
##for image in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    ...
    try:
        ...
        print('EOF')
        print('UP:', int(cnt_up+count_up))
        print('DOWN:',int(cnt_down+count_down))
        break
    #################
    #   CONTOURS   #
        #################
    ...
    # DISPLAY ON FRAME #
    ####################
    str_up = 'Entradas: '+ str(cnt_up+count_up)
    str_down = 'Saidas: '+ str(cnt_down+count_down)
